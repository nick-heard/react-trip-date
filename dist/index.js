...
var Wrapper$5 = styled__default["default"].div(
  templateObject_1$5 ||
                ...
                children: [
                  ...
                  !((_j =
                    ...
                    jsxRuntime.jsxs(
                      ...
                      {
                        children: [
                          jsxRuntime.jsx(SvgChevronLeft, {}, void 0),
                          displayMonths
                            ? jsxRuntime.jsx(SvgChevronLeft, {}, void 0)
                            : null,
                        ],
                ...
                children: [
                  ...
                  !((_s =
                    ...
                    jsxRuntime.jsxs(
                      ...
                      {
                        children: [
                          jsxRuntime.jsx(SvgChevronRight, {}, void 0),
                          displayMonths
                            ? jsxRuntime.jsx(SvgChevronRight, {}, void 0)
                            : null,
                        ],
...
var Wrapper$4 = styled__default["default"].div(
  templateObject_1$4 ||
...
var Month = styled__default["default"].div(
  templateObject_2 ||
...
var Weeks = styled__default["default"].div(
  templateObject_3 ||
    ...
    __assign(
      { jalali: jalali, startOfWeek: startOfWeek },
      {
        children: titles.map(function (item) {
          return jsxRuntime.jsx("p", { children: item }, item);
        }),
      },
    ),
    void 0,
...
var RangePicker = function (_a) {
  ...
  var _k = React.useState(selectedDaysProps),
    selectedDays = _k[0],
  ...
  var _o = React.useState(dayjsLocalized(jalali, initialMonthAndYear)),
    source = _o[0],
    setSource = _o[1];
  var _p = React.useState(numberOfMonthsProps),
    numberOfMonths = _p[0],
...
var DatePicker = function (_a) {
  ...
  var _k = React.useState(selectedDaysProps || []),
    selectedDays = _k[0],
    setSelectedDays = _k[1];
  var _l = React.useState(numberOfMonthsProps),
    numberOfMonths = _l[0],
